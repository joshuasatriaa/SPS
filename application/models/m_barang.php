...
class m_barang extends CI_Model{
	function tampilkanBarang(){
		...
		a.harga_barang, a.waktu_add, a.stok_barang, b.nama_pengguna, b.alamat alamat_pengguna, d.gambar_barang, d.id_foto_barang, c.nama_bengkel, e.alamat, f.status_membership 
		FROM barang a
		...
		WHERE d.id_foto_barang LIKE "FOTO-BARANG-%1" AND a.status_delete != 1 ORDER BY f.status_membership DESC
		');
	}
