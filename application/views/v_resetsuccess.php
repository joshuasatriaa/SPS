    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="text-center">
          <h1 class="text-capitalize mb-4 font-lg text-white">Forgot Your Password?</h1>
        </div>
      </div>
    </div>
  </div>
...
<div class="wrapper wrapper--w960">
    <div class="card card-2">
                <div class="card-heading success"></div>
                <div class="card-body">
                    <h4 class="title">Reset password success! Please check your email to get your new password.</h4>
                </div>
            </div>
</div>
</section>
